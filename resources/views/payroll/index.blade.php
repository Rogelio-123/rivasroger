                        ...
                        <tbody>
                            ...
                            @foreach ($payrolls as $o)
                                <tr>
                                    ...
                                    <td>${{ $o->total }}</td>
                                    <td>
                                        <a class="btn btn-outline-success" href="{{ route('payrolls.show', ['payroll' => $o->id]) }}"><i
                                                class="far fa-file"></i></a>
                                    </td>
                                    <td>
                                        <form class="formulario-eliminar" action="{{ route('payrolls.destroy', ['payroll' => $o->id]) }}"
                                            method="POST">
                                            {{ csrf_field() }}
                                            @method('DELETE')
