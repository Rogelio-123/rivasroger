                        ...
                        <tbody>
                            @foreach ($finances as $f)
                                <tr>
                                    ...
                                    <td>{{ $f->owner }}</td>
                                    <td>
                                        <a class="btn btn-outline-success" href=" {{ route('finances.show', ['finance' => $f->id]) }}">
                                            <i class="far fa-file"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-outline-warning" href=" {{ route('finances.edit', ['finance' => $f->id]) }}">
                                            <i class="far fa-file"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <form class="formulario-eliminar"
                                            action="{{ route('finances.destroy', ['finance' => $f->id]) }}" method="POST">
                                            {{ csrf_field() }}
                                            @method('DELETE')
