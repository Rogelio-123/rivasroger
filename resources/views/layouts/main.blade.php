    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDash" aria-expanded="true"
                ...
                <div id="collapseDash" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/home">Overview</a>
                        <a class="collapse-item" href="{{ route('clovers.index') }}">Clover</a>
                        <a class="collapse-item" href="{{ route('ubers.index') }}">Uber Eats</a>
                        <a class="collapse-item" href="{{ route('doordashs.index') }}">Doordash</a>
                        <a class="collapse-item" href="{{ route('postmates.index') }}">Postmates</a>
                        <a class="collapse-item" href="{{ route('grubhubs.index') }}">Grubhub</a>
                        <a class="collapse-item" href="{{ route('rivasapps.index') }}">Rivas App</a>
                    </div>
                </div>
            </li>
            ...
            {{-- @canany(['view_sales', 'create_sales', 'edit_sales', 'delete_sales'])
                <li class="nav-item">
                    <a class="nav-link" href="/sales">
                        ...
                        <span>{!! trans('messages.sales') !!}</span>
                    </a>
                </li>
            @endcan --}}
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @canany(['view_providers', 'create_providers', 'edit_providers', 'delete_providers'])
                            <a class="collapse-item" href="/providers">{!! trans('messages.providers') !!}</a>
                        @endcan

                        @canany(['view_services', 'create_services', 'edit_services', 'delete_services'])
                            <a class="collapse-item" href="/services">{!! trans('messages.services') !!}</a>
                        @endcan

                        @canany(['view_finances', 'create_finances', 'edit_finances', 'delete_finances'])
                            <a class="collapse-item" href="/finances">{!! trans('messages.finances') !!}</a>
                        @endcan

                        @canany(['view_purchase', 'create_purchase', 'edit_purchase', 'delete_purchase'])
                            <a class="collapse-item" href="/shoppings">{!! trans('messages.purchase') !!}</a>
                        @endcan

                        @canany(['view_expense', 'create_expense', 'edit_expense', 'delete_expense'])
                            <a class="collapse-item" href="/expenses">{!! trans('messages.expenses') !!}</a>
                        @endcan
                    </div>
                </div>
            </li>
                ...
                <div id="collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @canany(['view_employ', 'create_employ', 'edit_employ', 'delete_employ'])
                            <a class="collapse-item" href="/hr-and-payroll">{!! trans('messages.employs') !!}</a>
                        @endcan

                        @canany(['view_payroll', 'create_payroll', 'edit_payroll', 'delete_payroll'])
                            <a class="collapse-item" href="/payrolls">{!! trans('messages.payroll') !!}</a>
                        @endcan
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/products">{!! trans('messages.products') !!}</a>
                        @endcan
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/users">{!! trans('messages.users') !!}</a>
                        @endcan
            ...
            <li class="nav-item">
                <a class="nav-link" href="/credentials/{{ env('RIVAS_ID') }}/edit">
                <i class="fas fa-book"></i>
                <span>{!! trans('messages.credentials') !!}</span></a>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="/shoppings" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- Nav Item - Messages -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="/expenses" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{-- <i class="fas fa-envelope fa-fw"></i> --}}
                                <i class="fas fa-wallet"></i>
                                <!-- Counter - Messages -->
                                <span class="badge badge-danger badge-counter">
                                    {{ count($expensesPending) }}
                                </span>
                            </a>
                            <!-- Dropdown - Messages -->
                            {{-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
